...
2. Analyze the relationship between number of units and number of storeys
...
plot1
```
Reordered the property type, the x axis looks different than the previous plot.
...
plot2
```
I grouped social housing and TCHC together because they were far less than private housing; it would look neater.
...
**Research Question**: What is the relationship between number of stories and number of units?

**Variable of interest**: no_of_storeys and no_of_units
